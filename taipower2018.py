...
for date in datelist2018:
    for item in datedaily:
        url_link = "https://raw.githubusercontent.com/apan1121/powerInfo/power_log_2018/log/history/" + date + item
        try:
            ...
            name_a = item[1:6]
            dailypandas.to_csv('2018record/' + date + ' ' +
